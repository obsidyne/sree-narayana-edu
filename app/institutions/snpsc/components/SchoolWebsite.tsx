      ...
      <div className="bg-white p-4 sm:p-6 md:p-8">
        ...
        >
          <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">
            Sree Narayana Public School, Vilappuram,Chathannoor
          </h2>

          <p className="text-gray-700 text-xs sm:text-sm mb-4 sm:mb-6 leading-relaxed font-light">
            This School was established in the year 2015 and was upgraded to
            Senior Secondary Level in 2024. The School provides academic
            facility from play class to Senior Secondary Level. Much thrust is
            given for physical activities also in addition to the normal
            curricular activities. Sports is given due importance and in view of
            this the School has a well maintained ground for Foot ball and other
            sports activities. The School endeavours to transform into a premier
            institution in that part of Kollam District.
          </p>
        </div>
      </div>
    </div>
