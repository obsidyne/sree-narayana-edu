  ...
  return (
    <>
      ...
      <main className={`min-h-screen ${raleway.className}`}>
        {/* Hero Section */}
        <section className="w-full py-16 sm:py-24 bg-radial-[at_25%_25%] from-[#FFBF01] to-[#FFDD78]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl ml-[clamp(0px,10vw,151px)]">
              ...
              <div className="space-y-4 font-light text-[#3A3A3A]">
                <p className="text-base sm:text-lg leading-relaxed">
                  Our alumni are the pride of our institution, making
                  significant contributions across various fields including
                  healthcare, research, technology, and social service. They
                  continue to embody the values and principles we instilled
                  during their time here.
                </p>
                <p className="text-base sm:text-lg leading-relaxed">
                  From pioneering medical research to leading innovative
                  startups, our graduates are creating positive impact in
            ...
            <div className="max-w-5xl ml-[clamp(0px,10vw,151px)]">
              ...
              <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
                {featuredAlumni.map((alumni, index) => (
                  <article
                    key={index}
                    className="bg-white rounded-xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow duration-300"
                  >
        ...
        <section className="w-full py-12 sm:py-16 bg-radial-[at_25%_25%] from-[#FFBF01] to-[#FFDD78]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl ml-[clamp(0px,10vw,151px)]">
              ...
              <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
                <div>
                  ...
                  <div className="space-y-4 font-light text-[#3A3A3A]">
                    <p className="text-sm sm:text-base">
                      Join our alumni network to stay connected with fellow
                      graduates, share opportunities, and contribute to the
                      growth of our community.
                    </p>
                    <p className="text-sm sm:text-base">
                      Participate in alumni events, mentorship programs, and
                      give back to current students through your expertise and
                      experience.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 font-light text-[#3A3A3A]">
                    {[ 
                      "Register with your graduation details", 
                      "Update your current professional information", 
                      ...
                      <div key={i} className="flex items-start space-x-3">
                        <div className="w-6 h-6 bg-[#3A3A3A] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span className="text-[#FFE601] text-xs font-bold">
                            {i + 1}
                          </span>
                        </div>
            ...
            <div className="max-w-5xl ml-[clamp(0px,10vw,151px)]">
              <div className="text-center bg-gray-50 rounded-xl p-8 sm:p-12">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-6 font-light max-w-2xl mx-auto">
                  We'd love to hear about your achievements and journey. Your
                  story could inspire current students and fellow alumni.
                </p>
